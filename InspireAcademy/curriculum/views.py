...
from .models import Standard, Subject, Lesson, WorkingDays, TimeSlots
...
class CourseRegister(CreateView):
    context_object_name = 'registeredcourse'
    model = Standard
    template_name = 'curriculum/course_register.html'
